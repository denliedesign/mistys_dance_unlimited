    ...
    @foreach($placements as $placement)
        <div style="position: relative; background: linear-gradient(to bottom left, #008CC0, #ED174D); min-height: 100vh; height: 100%;" class="p-5 d-flex align-items-center">
            <div class="container py-5 rounded" style="background: white;">
                ...
                <div class="d-none d-md-block" style="position: absolute; bottom: 125px; left: 125px;"><img alt="dancer illustration" class="randomImage img-fluid" style="height: 300px; width: auto;"></div>
            </div>
        </div>
    @endforeach
@elseif(isset($placement))
    <div style="position: relative; background: linear-gradient(to bottom left, #008CC0, #ED174D); min-height: 100vh; height: 100%;" class="p-5 d-flex align-items-center">
        <div class="container py-5 rounded" style="background: white;">
            <h1 class="text-center text-red pacifico" style="font-size: 4em; position: relative; z-index: 3;">Congratulations, {{$placement->firstName}} {{ $placement->lastName }}!</h1>
            <div class="text-center raleway">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Select all elements with the class 'randomImage'
        const randomImageElements = document.querySelectorAll('.randomImage');

        // Loop through each image element
        randomImageElements.forEach(function (imgElement) {
            ...
            imgElement.src = randomImageFile;
        });
    });
</script>
