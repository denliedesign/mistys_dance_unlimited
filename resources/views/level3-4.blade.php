...
@section('title', 'Level III & IV | Misty\'s Dance Unlimited')
    ...
    <section class="class-info">
        ...
        <div class="season-table">
            <div class="season-row">
                <div class="season-item"><span>LVL III-IV &middot; High Int</span></div>
            ...
            <div class="season-row">
                <div class="season-item">Ballet III</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">6:30-7:30pm</div>
                <div class="season-item">6:30-7:30pm</div>
                <div class="season-item">8:15-9:15pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
            </div>
            <div class="season-row">
                <div class="season-item">Jazz III</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">7:30-8:30pm</div>
                <div class="season-item">5:00-6:00pm</div>
                <div class="season-item">7:15-8:15pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
            </div>
            <div class="season-row">
                <div class="season-item">Tap III</div>
                <div class="season-item"><span class="nada"></span></div>
            ...
            <div class="season-row">
                <div class="season-item">Ballet IV</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">7:30-8:30pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">6:30-7:30pm</div>
            ...
            <div class="season-row">
                <div class="season-item">Jazz IV</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">5:30-6:30pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">5:30-6:30pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
            ...
            <div class="season-row">
                <div class="season-item">Tap IV</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">6:30-7:15pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">8:00-8:45pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
            </div>
            <div class="season-row">
                ...
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">7:45-8:30pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
            </div>
            ...
            <div class="season-row">
                ...
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">8:00-8:30pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
            ...
            <div class="season-row">
                <div class="season-item">Pre-Pointe / Pointe I</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">8:30-9:00pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">7:30-8:00pm</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
            </div>
            <div class="season-row">
                <div class="season-item">Partnering (Levels 3-5)</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">7:30-8:15pm</div>
            ...
            <div class="season-row">
                <div class="season-item">Open Ballet</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">10:30-11:30am</div>
            </div>
            <div class="season-row">
                <div class="season-item">Open Pointe (Pre-Pointe and up!)</div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item"><span class="nada"></span></div>
                <div class="season-item">11:30-12:00pm</div>
            </div>

            <div class="season-row">
                <div class="season-item" id="season-tuition">$59/mo per class</div>
            </div>
        </div>
    </section>
    <br><br><br><br>
