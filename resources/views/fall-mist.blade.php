    ...
    <div class="bg-white">
        <div class="container pb-5 pt-3">
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-2 mt-4">
                <img src="/images/7-20-26-fall-schedule-1.jpg" alt="fall schedule" class="img-fluid p-1" id="ab">
                <img src="/images/7-20-26-fall-schedule-2.jpg" alt="fall schedule" class="img-fluid p-1" id="ab">
                <img src="/images/7-20-26-fall-schedule-3.jpg" alt="fall schedule" class="img-fluid p-1" id="c">
                <img src="/images/7-20-26-fall-schedule-4.jpg" alt="fall schedule" class="img-fluid p-1" id="d">
                <img src="/images/7-20-26-fall-schedule-5.jpg" alt="fall schedule" class="img-fluid p-1" id="e">
                <img src="/images/7-20-26-fall-schedule-6.jpg" alt="fall schedule" class="img-fluid p-1">
                <img src="/images/7-20-26-fall-schedule-7.jpg" alt="fall schedule" class="img-fluid p-1">
                <img src="/images/7-20-26-fall-schedule-8.jpg" alt="fall schedule" class="img-fluid p-1" id="age-guys">
                <img src="/images/7-20-26-fall-schedule-9.jpg" alt="fall schedule" class="img-fluid p-1">
                <img src="/images/7-20-26-fall-schedule-10.jpg" alt="fall schedule" class="img-fluid p-1">
                <img src="/images/7-20-26-fall-schedule-11.jpg" alt="fall schedule" class="img-fluid p-1">
                <img src="/images/7-20-26-fall-schedule-12.jpg" alt="fall schedule" class="img-fluid p-1">
{{--                <img src="/images/6-28-26-program-guide-13.jpg" alt="fall schedule" class="img-fluid p-1">--}}
            </div>
        </div>
    </div>
