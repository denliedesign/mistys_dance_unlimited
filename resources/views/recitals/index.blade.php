...
{{--            </div>--}}
            ...
            <div class="recital-wrap pb-5">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
                    <a class="recital-box col" href="/recitals/generals"><div><p class="recital-txt">Zoom Recital Party Week</p></div></a>
                    <a class="recital-box col" href="/recitals/performances"><div><p class="recital-txt">Red Carpet Recital Experience</p></div></a>
                    <a class="recital-box col" href="/recitals/memories"><div><p class="recital-txt">Recital Memory T-shirt & Puppy Order Form</p></div></a>
                </div>
            </div>
