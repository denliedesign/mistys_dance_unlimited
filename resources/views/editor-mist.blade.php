<script>
    // Load the editor only on pages that actually contain an editor field.
    if (document.querySelector('#mytextarea, textarea[id$="-textarea"]')) {
        var editorScript = document.createElement('script');
        editorScript.src = 'https://cdn.tiny.cloud/1/no-api-key/tinymce/5/tinymce.min.js';
