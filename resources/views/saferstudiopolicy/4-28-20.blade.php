...
@section('content')
    ...
    <div class="container my-5">
        <h1 class="text-center">MDU Family Chat #2 Recital Reimagined, Summer & Fall Info</h1>
        <p>
            Dear MDU Families,
            <br><br>
            ...
            <br><br>
            <strong>Our plans for Recital, Summer, Fall & More are described in this 20-minute video presentation and outlined below.</strong>
            <br><br>
            <a href="https://www.youtube.com/watch?v=iDCtt20CAKU&t=1s">Watch Video</a>
            <br><br>
            ...
            <br><br>
            <strong>Recital Reimagined:</strong>
            <br><br>
            We will be offering two opportunities for families to reimagine recital and to showcase the accomplishments of our ALL of our students. Learn more at our
            <a href="/recitals">Recital Page.</a>
            <br><br>
            ...
            <br><br>
            <strong>Performance Company Competition and Ballet La Crosse Performance</strong>
            <br><br>
            Our team is working hard on rescheduling options for these events with vendors. Stay tuned for more information!
            <br><br>
            <strong>A Special Note for Seniors</strong>
            <br><br>
            ...
            <br><br>
            <strong>Summer and Fall Schedules</strong>
            <br><br>
            ...
            <br><br>
        <ul>
            <li>Next Week:        Information regarding Curbside Costume Pick Up Options</li>
            <li>May 1:                Performing Group Audition info available</li>
            <li>May 1:                Updated Summer Programming Released</li>
            <li>May 11-16:         MDU’s Virtual Recital Experience Week!</li>
            <li>May 18-26:         MDU office closed for schedule, placement, performance prep</li>
            <li>May 26:               Level Placements and Fall Schedule emailed</li>
            <li>May 27-June 5:  MDU’s Red Carpet Recital Experience!</li>
            <li>June 1:                Extended Early Bird Deadline for Summer Programs</li>
            <li>June 6:                Fall Registration begins per the previous schedule online</li>
        </ul>

        As we look past Phase 1 to Phase 2 and 3 operations we are making an outline for the following:
        <br><br>
        <ul>
            <li>Mid June-Early August:            Modified Summer Programs</li>
            <li>Late July or Early August:        Potential rescheduling of PC Comp dates</li>
            <li>Early August:                            BLC Mozart’s Requiem Performance</li>
            <li>Mid August:                              Start date for 2020-21 regular classes</li>
            <li>Mid-October:                            Fall break (or back up in event of 2nd wave)</li>
        </ul>

        To be determined:
        <br><br>
        <ul>
            <li>Christmas Cookie Social Structure</li>
            <li>Ballet La Crosse Full Length Ballet</li>
        </ul>
        ...
        <br><br>
        <strong>NEW - MDU Helping Hands Initiative</strong>
        <br><br>
