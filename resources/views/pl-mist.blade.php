...
@section('content')
    ...
    <div class="bg-white">
        <div class="container pb-5 pt-3">
            <div class="row">
                <div class="col-sm">
                    <div class="d-flex justify-content-center">
                        <img src="/images-lava/private-lesson.jpg" alt="alumni logo" class="img-fluid rounded shadow">
                    </div>
                </div>
                <div class="col-sm">
                    <h1 class="born-7 poppins fw-bold p-0 m-0" style="font-size: 45px;">Private Lessons</h1>
                    <div class="poppins" style="font-size: 20px;">
                        <p class="text-muted">Get the greatest value out of your dance classes by taking private lessons!</p>
                        <p>
            ...
            <div class="poppins mt-4" style="font-size: 20px;">
                <!-- <strong>NEW – 2 Great MDU Teacher Options for Private Lessons</strong>
                <ul>
                    <li>MDU Faculty </li>
                ...
                <p><strong>Rates and Scheduling:</strong></p>
                <p>
                    Schedule Your MDU Faculty Private Lessons Today!<br><br>
                    Private lessons begin at $20/half hour and vary by teacher.<br>
                </p>
                <div style="background: #008CC0; color: white; font-size: 20px;" class="btn poppins fw-bold btn-interact"><a class="text-white text-decoration-none" href="http://www.supersaas.com/schedule/MDUPrivateLessons/Private_Lesson" target="_blank">Schedule Now!</a></div>
                <br><br>
