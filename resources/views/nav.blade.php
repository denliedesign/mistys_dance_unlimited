...
{{--                <br><br>--}}
{{--                But as for me right now, my answer is "NO". I will open again one day, but today is not that day for me. <ion-icon name="heart" class="text-danger"></ion-icon>--}}
{{--                <br><br>--}}
...
{{--                <br><br>--}}
{{--                Thank you, teachers and families, for your support. <ion-icon name="heart" class="text-danger"></ion-icon>--}}
{{--                <br><br>--}}
