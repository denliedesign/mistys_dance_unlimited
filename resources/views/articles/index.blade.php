...
{{--                            <a href="/articles/{{ $article->id }}">--}}
                                <img src="/storage/FRM0ARA8Xl0xPfPIvGuuol1YbJCI3SRqjsyXkmzt.png" class="card-img-top" alt="...">
{{--                                <img src="{{ asset('/storage/' . $article->newsImage) }}" class="card-img-top" alt="...">--}}
                            </a>
                            <div class="card-body">
                                <p class="card-title text-uppercase lead fw-bold">May 2024 News</p>
{{--                                <p class="card-title text-uppercase lead fw-bold">{{ $article->newsTitle }}</p>--}}
                                <p class="card-text">Spring Recital Updates, Audition Sign Up Reminders and MORE!</p>
