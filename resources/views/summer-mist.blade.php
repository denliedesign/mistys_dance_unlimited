...
@section('content')
    ...
    <div class="bg-white py-5 poppins">
        <div class="container" id="summer">
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1">
                <img src="images/2025-summer-graded-1.jpg" alt="summer dance classes" class="my-3">
                <img src="images/2025-summer-graded-2.jpg" alt="summer dance classes" class="my-3">
                <img src="images/2025-summer-graded-3.jpg" alt="summer dance classes" class="my-3">
                <img src="images/2025-summer-graded-4.jpg" alt="summer dance classes" class="my-3">
                <img src="images/2025-summer-graded-5.jpg" alt="summer dance classes" class="my-3">
                <img src="images/2025-summer-graded-6.jpg" alt="summer dance classes" class="my-3">
            </div>
