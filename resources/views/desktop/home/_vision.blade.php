<div class="d-none d-md-block mx-5 text-center">
    <h1 class="born-3 poppins fw-bold p-0 m-0" style="font-size: 80px; transform: translateY(45px); opacity: 0;">Dance makes great <ion-icon name="happy-outline"></ion-icon> kids!</h1>
