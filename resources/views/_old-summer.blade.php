    ...
    <div class="bg-white py-5">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-4 row-cols-lg-4">
                ...
                />
                <x-summer-class
                    logo="logo-lets-go-to-the-zoo.png"
                ...
                />
                <x-summer-class
                    logo="logo-ballerina-dollhouse.png"
                ...
                />
                <x-summer-class
                    logo="logo-beginning-ballet.png"
                ...
                />
                <x-summer-class
                    logo="logo-mermaid-tumbling.png"
...
climbing, obstacle courses and acro."
                />
                <x-summer-class
                    logo="logo-flexibility-focus.png"
